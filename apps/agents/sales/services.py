...
async def generate_strategy_context(strategy_payload: Dict[str, Any]) -> str:
    """Flatten relevant strategy sections into a prompt-friendly string (deduped)."""
    from shared.strategy_utils import summarize_strategy_payload
    summary = summarize_strategy_payload(strategy_payload)
    return summary or "Use general sales best practices."
...
# Deprecated duplicate; use apps.integrations.telephony.twilio.twilio_service.make_call
